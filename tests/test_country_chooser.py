...
def test_init_with_seed_and_timezone():
    seed = 1234
    chooser = CountryChooser(seed=seed, timezone="America/New_York")
    ...
    with freeze_time("2024-11-13 18:00:00"):
        result = chooser.choose(number_of_countries=244)
        assert result == 193
    ...
    with freeze_time("2024-11-14 18:00:00"):
        new_result = chooser.choose(number_of_countries=244)
        assert new_result == 138
...
def test_hash_seed():
    ...
    seed = 31415926
    chooser = CountryChooser(seed=seed)
